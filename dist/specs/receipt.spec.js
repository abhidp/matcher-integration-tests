...
const data = __importStar(require("../data/receipt.json"));
const options = __importStar(require("../config/options"));
const axios_1 = __importDefault(require("axios"));
const chai_1 = require("chai");
describe('matcher integration test', () => __awaiter(void 0, void 0, void 0, function* () {
    it('create a random receipt', () => __awaiter(void 0, void 0, void 0, function* () {
        const config = yield options.options('POST', '/receipts', data);
